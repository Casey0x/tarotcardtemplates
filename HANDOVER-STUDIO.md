...
8. **Borders:** `borders/[slug]` has `templated_template_id`; `BorderPurchase` component with pricing (Single / Major Arcana 22 / Full 78) and Purchase → `/api/checkout`. Vintage Velvet template ID: `8d9f0783-63e3-4947-955f-2dfcfd4f6f93`. Layers: card-artwork, card-title, card-numeral.
